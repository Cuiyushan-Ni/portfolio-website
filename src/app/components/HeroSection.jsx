      ...
      <div className="grid grid-cols-1 sm:grid-cols-12">
        ...
        >
          ...
          <p className="text-[#ADB7BE] text-base sm:text-lg mb-6 lg:text-xl">
            Actively seeking SDE/SWE (Backend/Full-Stack) roles across Canada. Edmonton-based; open to relocation and remote/hybrid.
          </p>
          <div>
            ...
            <a
              ...
              className="px-1 py-1 w-full sm:w-fit rounded-full bg-gradient-to-br from-blue-500 via-purple-500 to-pink-500 text-white mt-3 inline-block"
